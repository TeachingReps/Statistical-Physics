...
%Second partial derivative of free entropy with respect to the inverse temperature is auto-covariance of energy under the Boltzmann distribution. 
%That is, $-\frac{\partial ^2}{\partial \beta^2} \left( \beta F(\beta) \right)=\inner{ E^2 }-\inner{ E }^2$. 
\begin{proof} 
We can write the second partial derivative of free entropy as first partial derivative of the negative free energy, 
and hence 
\EQ{
\frac{\partial ^2}{\partial \beta^2} \left(\Phi(\beta) \right)=-\frac{\partial}{\partial \beta} \left( U(\beta)\right) 
...
\EQ{
\frac{\partial ^2}{\partial \beta^2} \left( \Phi(\beta) \right) = -\frac{\partial ^2}{\partial \beta^2} \left( \beta F(\beta) \right) =\inner{E^2}-\inner{E}^2.
}
